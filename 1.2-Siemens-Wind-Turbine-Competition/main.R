...
datafilename1 = "All_Sites_Together_encoded.csv"
datafilename2 = "Codes_and_Event_Warning_Stop_classification.csv"
...
outdatapath = "./Output/table/"

# CHANGE THE PATH FOR SVING PLOTS
outplotpath = "./Output/Plot/"
...
################################################################################
# MARKOV CHAIN ANALYSIS - EWS_StopUr_B_A_concate
################################################################################
...
write.csv(max5MC_prob, file = paste0(outdatapath, "Conditional_Probability.csv", collapse = ""))
...
write.csv(max5MC_prob, file = paste0(outdatapath,"Transition_Probability.csv", collapse = ''))
...
################################################################################
# MARKOV CHAIN ANALYSIS - CodeCluster
################################################################################
...
################################################################################
# PATTERN ANALYSIS AND NETWORK DATA
################################################################################
